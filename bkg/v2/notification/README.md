...
- [Booking API](https://app.swaggerhub.com/apis-docs/dcsaorg/DCSA_BKG) maintained on SwaggerHub and is the API linked to the Booking Notification
- ["What's New" in Booking specification](./../) maintained here on GitHub
