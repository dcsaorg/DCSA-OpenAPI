### Electronic Bill of Lading Notification API

The DCSA API specification for Bill of Lading notification is documented on the [**DCSA Bill of Lading Notification SwaggerHub**](https://app.swaggerhub.com/apis/dcsaorg/DCSA_EBL).
